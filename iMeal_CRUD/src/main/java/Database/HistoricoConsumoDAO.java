...
public class HistoricoConsumoDAO implements DAO<HistoricoConsumo> {
    ...
    public List<HistoricoConsumoLimitado> readVw_Compareceram(Integer usuarioId, Integer cardapioId) throws Exception {
        String sql
                = "SELECT * FROM vw_Compareceram WHERE USUARIO_ID = " + usuarioId
                + " And CARDAPIO_ID = " + cardapioId;
    ...
    public List<HistoricoConsumoLimitado> readVw_NaoCompareceram(Integer usuarioId, Integer cardapioId) throws Exception {
        String sql
                = "SELECT * FROM vw_NaoCompareceram WHERE USUARIO_ID = " + usuarioId
                + " And CARDAPIO_ID = " + cardapioId;
    ...
    public List<HistoricoConsumoLimitado> readVw_TentouEntrarSemAgendar(Integer usuarioId, Integer cardapioId) throws Exception {
        String sql
                = "SELECT * FROM vw_TentouEntrarSemAgendar WHERE USUARIO_ID = " + usuarioId
                + " And CARDAPIO_ID = " + cardapioId;
    ...
    public List<HistoricoConsumoLimitado> readVw_TentouEntrarDenovo(Integer usuarioId, Integer cardapioId) throws Exception {
        String sql
                = "SELECT * FROM vw_TentouEntrarDenovo WHERE USUARIO_ID = " + usuarioId
                + " And CARDAPIO_ID = " + cardapioId;
...
//    public List<HistoricoConsumoLimitado> countVw_Compareceram(Integer usuarioId, Integer cardapioId) throws Exception {
//        String sql
//                = "SELECT COUNT(*) FROM vw_Compareceram WHERE USUARIO_ID = " + usuarioId
//                + " And CARDAPIO_ID = " + cardapioId;
//
//        Connection connection = connectionFactory.getConnection();
//        Statement statement = connection.createStatement();
...
//    }
//
//    public List<HistoricoConsumoLimitado> countVw_NaoCompareceram(Integer usuarioId, Integer cardapioId) throws Exception {
//        String sql
//                = "SELECT COUNT(*) FROM vw_NaoCompareceram WHERE USUARIO_ID = " + usuarioId
//                + " And CARDAPIO_ID = " + cardapioId;
//
//        Connection connection = connectionFactory.getConnection();
//        Statement statement = connection.createStatement();
...
//    }
//
//    public List<HistoricoConsumoLimitado> countVw_TentouEntrarSemAgendar(Integer usuarioId, Integer cardapioId) throws Exception {
//        String sql
//                = "SELECT COUNT(*) FROM vw_TentouEntrarSemAgendar WHERE USUARIO_ID = " + usuarioId
//                + " And CARDAPIO_ID = " + cardapioId;
//
//        Connection connection = connectionFactory.getConnection();
//        Statement statement = connection.createStatement();
...
//    }
//
//    public List<HistoricoConsumoLimitado> countVw_TentouEntrarDenovo(Integer usuarioId, Integer cardapioId) throws Exception {
//        String sql
//                = "SELECT COUNT(*) FROM vw_TentouEntrarDenovo WHERE USUARIO_ID = " + usuarioId
//                + " And CARDAPIO_ID = " + cardapioId;
//
//        Connection connection = connectionFactory.getConnection();
//        Statement statement = connection.createStatement();
